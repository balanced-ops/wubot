...
#
# Configuration:
#   HUBOT_TRELLO_KEY - your trello developer application key
#
# Commands:
...
#
# Author:
#   beezly (https://github.com/beezly/hubot-trello)
#   balanced-ops (https://github.com/balanced-ops/wubot)
...
module.exports = (robot) ->
  ...
  robot.respond /trello get token/, (msg) ->
    msg.send ("Get a token from https://trello.com/1/authorize?" +
              "key=#{trello_key}&name=wubot&expiration=30days&"  +
